    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           // int[,] puzzle2D = readFromFile("15 Puzzle 5.txt", out puzzle1D, out size, out blankRow, out blankCol);//45
            ...
            //Unsolvable
            //sample (Done)
            //int[,] puzzle2D = readFromFile(@"Unsolvable\8 Puzzle - Case 1.txt", out puzzle1D, out size, out blankRow, out blankCol);//24
           // int[,] puzzle2D = readFromFile(@"Unsolvable\8 Puzzle(2) - Case 1.txt", out puzzle1D, out size, out blankRow, out blankCol);//24
            //int[,] puzzle2D = readFromFile(@"Unsolvable\8 Puzzle(3) - Case 1.txt", out puzzle1D, out size, out blankRow, out blankCol);//24
            //int[,] puzzle2D = readFromFile(@"Unsolvable\15 Puzzle - Case 2.txt", out puzzle1D, out size, out blankRow, out blankCol);//24
            //int[,] puzzle2D = readFromFile(@"Unsolvable\15 Puzzle - Case 3.txt", out puzzle1D, out size, out blankRow, out blankCol);//24

            //complete (Done)
            //int[,] puzzle2D = readFromFile(@"Unsolvable\15 Puzzle 1 - Unsolvable.txt", out puzzle1D, out size, out blankRow, out blankCol);//24
            //int[,] puzzle2D = readFromFile(@"Unsolvable\99 Puzzle - Unsolvable Case 1.txt", out puzzle1D, out size, out blankRow, out blankCol);//24
            //int[,] puzzle2D = readFromFile(@"Unsolvable\99 Puzzle - Unsolvable Case 2.txt", out puzzle1D, out size, out blankRow, out blankCol);//24
            //int[,] puzzle2D = readFromFile(@"Unsolvable\9999 Puzzle.txt", out puzzle1D, out size, out blankRow, out blankCol);//24
